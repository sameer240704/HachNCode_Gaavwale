...
const Home = () => {
  ...
  return (
    <div>
      ...
      <Lottie className="arrow" animationData={arrow}/>
      <h1 className='banner-heading'>Improve your <span>{text}</span> faster!</h1>
      <p className='banner-text'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsa ab ipsam illum expedita ducimus at totam hic quis voluptatibus odit.</p>
    </div>
  )
}
